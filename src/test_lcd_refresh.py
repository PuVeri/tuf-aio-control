...
EXPECTED_BCD_DEVICE = lcd_runtime_safety.EXPECTED_BCD_DEVICE
EXPECTED_BCD_DEVICE_DISPLAY = lcd_runtime_safety.EXPECTED_BCD_DEVICE_DISPLAY
EXPECTED_MANUFACTURER = lcd_runtime_safety.EXPECTED_MANUFACTURER
EXPECTED_PRODUCT = lcd_runtime_safety.EXPECTED_PRODUCT
EXPECTED_USAGE_PAGE = lcd_runtime_safety.EXPECTED_USAGE_PAGE
EXPECTED_USAGE = lcd_runtime_safety.EXPECTED_USAGE
EXPECTED_SEGMENTS = 3
EXPECTED_WRITES = 15
EXPECTED_ENDPOINTS = lcd_runtime_safety.EXPECTED_ENDPOINTS
...
def parse_bcd_device(value: str | None) -> int | None:
    ...
    return lcd_runtime_safety.parse_bcd_device(value)
...
def strict_device_error(device: HidrawInterface) -> str | None:
    ...
    return lcd_runtime_safety.strict_device_error(device)
...
def find_competing_writers(device: HidrawInterface) -> tuple[str, ...]:
    ...
    return lcd_runtime_safety.find_competing_writers(device)
